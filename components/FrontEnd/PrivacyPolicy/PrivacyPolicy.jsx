    ...
    return (
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="prose prose-lg max-w-none">
          <p className="lead">Last updated: March 10, 2025</p>
  
          <p>
            At Alberow, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, and
          ...
          <p>
            ...
            about our services from the Website.
          </p>
          ...
          <ul>
            ...
            <li>Send you email newsletters, updates, and promotional materials.</li>
